        ...
        <div className="min-h-screen bg-slate-950 text-white">
            ...
            <div className="container mx-auto px-4 sm:px-6 py-6 sm:py-10">
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 sm:mb-8">
                    <div>
                        <h1 className="text-2xl sm:text-3xl font-bold">{isEditing ? 'Editar paquete' : 'Crear paquete'}</h1>
                        <p className="text-slate-400 text-sm">{isEditing ? 'Actualiza los datos del paquete.' : 'Crea un nuevo paquete disponible para reservas.'}</p>
                    </div>
                    <Link href={route('admin.packages')} className="text-sm bg-slate-800 border border-slate-700 px-4 py-2 rounded-lg hover:bg-slate-700 transition text-center">
                        Volver a lista
                    </Link>
                </div>
